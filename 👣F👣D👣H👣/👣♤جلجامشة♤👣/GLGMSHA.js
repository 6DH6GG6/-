...
.splash-bg {
  ...
  inset: 0;
  background:
    radial-gradient(ellipse at 15% 15%, #ff4d9e44 0%, transparent 50%),
    radial-gradient(ellipse at 85% 10%, #c084fc44 0%, transparent 45%),
    radial-gradient(ellipse at 50% 90%, #ff4d9e66 0%, transparent 55%),
    linear-gradient(170deg, #1e0030 0%, #0e0018 45%, #180008 100%);
  z-index: 0;
}
...
.garden-grass {
  ...
  right: 0;
  height: 55px;
  background: linear-gradient(180deg, #2a6020, #193810);
...
.garden-grass::before {
  ...
  right: 0;
  height: 30px;
  background: linear-gradient(180deg, #358226, #2a6020);
...
.flower-stem {
  width: 3px;
  background: linear-gradient(180deg, #358226, #193810);
  border-radius: 2px;
}
...
.flower-head {
  font-size: 1.6rem;
  margin-bottom: -3px;
  filter: drop-shadow(0 0 5px #ff69b488);
  animation: bloomPulse ease-in-out infinite;
}
...
.splash-ring-outer::before {
  ...
  inset: 0;
  border-radius: 50%;
  background: conic-gradient(from 0deg, #ff4d9e, #c084fc, #fb7185, #fda4c8, #ff4d9e);
...
.splash-avatar-inner {
  ...
  height: 94px;
  border-radius: 50%;
  background: radial-gradient(circle at 35% 30%, #3a0050, #12001a);
  display: flex;
  align-items: center;
  justify-content: center;
  font-size: 3rem;
  position: relative;
  z-index: 1;
  box-shadow: 0 0 30px #ff4d9e33 inset;
  filter: drop-shadow(0 0 16px #ff4d9e88);
...
.splash-title {
  ...
  letter-spacing: .5px;
  line-height: 1.4;
  text-shadow: 0 2px 24px #ff4d9e55, 0 0 60px #c084fc33;
}
...
.splash-divider-line {
  flex: 1;
  height: 1px;
  background: linear-gradient(90deg, transparent, #ff4d9e55, transparent);
}
...
#splash-btn {
  ...
  border-radius: 50%;
  border: none;
  background: linear-gradient(135deg, #ff4d9e, #c084fc 50%, #fb7185);
  background-size: 200% 200%;
  animation: btnShift 3s ease-in-out infinite, btnGlow 2.5s ease-in-out infinite;
  color: #fff;
  font-size: 1.5rem;
  display: flex;
  align-items: center;
...
@keyframes btnGlow {
  0%, 100% { box-shadow: 0 8px 32px #ff4d9e66, 0 0 0 0 #ff4d9e22; }
  50%       { box-shadow: 0 8px 44px #ff4d9eaa, 0 0 0 14px #ff4d9e11; }
}
...
#splash-btn::before {
  ...
  inset: -7px;
  border-radius: 50%;
  border: 1.5px solid #ff4d9e44;
  animation: rippleSplash 2s linear infinite;
}
...
#splash-btn::after {
  ...
  border-radius: 50%;
  border: 1px solid #ff4d9e22;
  animation: rippleSplash 2s linear infinite .65s;
}
...
#splash-btn:active { transform: scale(.93); }
...
.loader-bar-fill {
  ...
  width: 0%;
  border-radius: 99px;
  background: linear-gradient(90deg, #ff4d9e, #c084fc, #fb7185, #ff4d9e);
...
.home-avatar-ring::before {
  content: '';
  position: absolute;
  inset: 0;
  border-radius: 50%;
  background: conic-gradient(from 0deg, #ff4d9e, #c084fc, #fda4c8, #fb7185, #ff4d9e);
...
.home-name {
  ...
  font-weight: 900;
  color: #fff;
  text-shadow: 0 0 20px #ff4d9e55;
  text-align: center;
}

.home-name-gradient {
  background: linear-gradient(90deg, #ff4d9e, #c084fc, #fda4c8);
...
.menu-card {
  ...
  gap: 10px;
  text-align: center;
  background: linear-gradient(145deg, #1c0026ee, #120018ee);
  border: 1px solid #ff4d9e22;
...
.menu-card::after {
  ...
  position: absolute;
  inset: 0;
  background: radial-gradient(circle at 50% 0%, #ff4d9e0d, transparent 65%);
  opacity: 0;
  transition: opacity .3s;
}

.menu-card:hover {
  border-color: #ff4d9e66;
  box-shadow: 0 8px 32px #ff4d9e22, 0 0 0 1px #ff4d9e11;
...
.menu-card-icon {
  font-size: 2rem;
  line-height: 1;
  filter: drop-shadow(0 0 8px #ff4d9e66);
...
#notif-fab {
  ...
  height: 54px;
  border-radius: 50%;
  border: 1px solid #ff4d9e44;
  background: linear-gradient(145deg, #2a0030, #12001a);
  box-shadow: 0 4px 24px #ff4d9e33, inset 0 1px 0 #ff4d9e22;
  display: flex;
  align-items: center;
  justify-content: center;
  cursor: pointer;
...
#notif-fab::before {
  ...
  inset: 0;
  border-radius: 50%;
  background: radial-gradient(circle at 35% 30%, #ff4d9e11, transparent 70%);
}
...
#notif-fab-badge {
  ...
  top: -4px;
  right: -4px;
  background: linear-gradient(135deg, #ff4d9e, #c084fc);
  color: #fff;
  font-size: .6rem;
  font-weight: 900;
  border-radius: 99px;
  ...
  min-width: 18px;
  text-align: center;
  border: 1.5px solid #12001a;
  display: none;
  box-shadow: 0 2px 8px #ff4d9e66;
}
...
#notif-drawer {
  ...
  background: linear-gradient(160deg, #1e0028f8, #110016f8);
  border: 1px solid #ff4d9e33;
  border-radius: 22px;
  box-shadow: 0 12px 50px #ff4d9e22, 0 2px 0 #ff4d9e11 inset;
...
#notif-drawer::before {
  ...
  right: 0;
  height: 1px;
  background: linear-gradient(90deg, transparent, #ff4d9e44, transparent);
}
...
.notif-drawer-header {
  ...
  border-bottom: 1px solid #ff4d9e11;
}

.notif-drawer-title {
  font-size: .88rem;
  font-weight: 900;
  background: linear-gradient(90deg, #ff4d9e, #c084fc);
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
  background-clip: text;
  letter-spacing: 1px;
...
.notif-list-inner {
  ...
  scrollbar-color: #ff4d9e22 transparent;
  padding: 6px 0;
}
...
.notif-item {
  ...
  border-bottom: 1px solid #ff4d9e08;
}
...
.sec-header {
  ...
  top: 0;
  z-index: 5;
  background: linear-gradient(180deg, #12001aee, #0e0015ee);
  backdrop-filter: blur(12px);
  -webkit-backdrop-filter: blur(12px);
  border-bottom: 1px solid #ff4d9e22;
  box-shadow: 0 4px 24px #0e001588;
  display: flex;
  align-items: center;
  gap: 12px;
  padding: 12px 16px;
...
.sec-header::after {
  ...
  right: 0;
  height: 1px;
  background: linear-gradient(90deg, transparent, #ff4d9e33, transparent);
}
...
@media (max-width: 360px) {
  .menu-grid       { gap: 9px; }
  .menu-card       { padding: 16px 10px 13px; }
  .menu-card-icon  { font-size: 1.7rem; }
  .menu-card-label { font-size: .8rem; }
}
...
<audio id="bg-audio" loop preload="auto">
  <source src="⚜️F⚜️I⚜️L⚜️E⚜️S⚜️/⚜️🎶⚜️/🎵T🎵H🎵R🎵.ogg" type="audio/ogg"/>
</audio>

<canvas id="stars-global"></canvas>
...
function openSection(id, file, globalName, label, cardEl) {
  ...
  fetch(file, { method: 'HEAD' })
    .then(function(res) {
      if (res.ok) {
        checkedFiles.set(file, true);
        _doOpen(id, file, globalName, label, cardEl);
      } else {
        checkedFiles.set(file, false);
        pulseCard(cardEl);
      }
    })
    .catch(function() {
...
function _doOpen(id, file, globalName, label, cardEl) {
  ...
  requestAnimationFrame(function() {
    requestAnimationFrame(function() {
      sectionPage.classList.add('slide-in');
    });
  });
...
function closeSection() {
  ...
  setTimeout(function() {
    homeMenu.classList.remove('hide-out');
    fab.style.display = '';
  }, 50);
}

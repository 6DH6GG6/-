(function() {
        ...
        try {
            const storageHandler = {
                get: function(target, prop) {
                    ...
                    triggerInterceptorReport("Storage Access", `محاولة قراءة الـ Storage المفتاح: (${String(prop)})`, "Proxy Interception", "null");
                ...
                set: function(target, prop, value) {
                    ...
                    triggerInterceptorReport("Storage Write", `محاولة تعديل الـ Storage المفتاح: (${String(prop)}) بقيمة: (${String(value)})`, "Proxy Block", "null");
                    return false; 
                }
            };
            ...
            Storage.prototype.getItem = function(key) {
                ...
                triggerInterceptorReport("getItem()", `طلب المفتاح: '${key}'`, "Prototype Override", "null");
                return null;
            };
            ...
            Storage.prototype.setItem = function(key, value) {
                ...
                triggerInterceptorReport("setItem()", `حفظ المفتاح: '${key}' بقيمة: '${value}'`, "Prototype Override", "null");
                return null;
            };
        } catch (e) {}
    };
    ...
    const secureConsoleAndIntercept = () => {
        ...
        methods.forEach(method => {
            ...
            console[method] = function(...args) {
                ...
                triggerInterceptorReport("Console Extraction", inputContent || 'Unknown/Empty', "Forced Null", "null");
                return null; 
            };
        });
        ...
        window.eval = function(code) {
            ...
            triggerInterceptorReport("eval() Execution", code, "Execution Blackhole", "null");
            return null;
        };
        ...
        window.Function = new Proxy(window.Function, {
            construct(target, args) {
                ...
                triggerInterceptorReport("Function Constructor", checkArgs, "Constructor Block", "null");
                return function() { return null; };
            }
        });
    };
    ...
    window.addEventListener('keydown', function(e) {
        if (
            ...
            e.preventDefault();
            triggerInterceptorReport("Keyboard Shortcut", `الضغط على زر: ${e.key}`, "Key Prevention", "null");
            return false;
        }
    });
